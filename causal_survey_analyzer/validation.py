...
def check_response_encoding(data, question_col, raw_response_col, score_col, encoding_map=None):
    """
...
def check_data_abnormalities(data, design, required_cols, userid_col, treatment_col, time_col=None):
    """
